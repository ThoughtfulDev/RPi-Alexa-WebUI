<template>
  <div class="boxcontainer">
    <h2 v-if="isOnline" id="online">WakeWord Agent is online</h2>
    <h2 v-if="!isOnline" id="offline">WakeWord Agent is offline</h2>
    <hr />
    <el-row :gutter="20">
      <!-- Log -->
...
<script>
  export default {
    ...
    methods: {
      ...
      getLog: function() {
        let self = this;
        this.$store.state.axios.get('service/wakewordagent/log')
        .then(function (response) {
